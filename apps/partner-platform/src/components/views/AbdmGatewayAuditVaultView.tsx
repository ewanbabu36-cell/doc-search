...
import type { AbdmAuditTraceDto } from '@docsearch/api-contracts';

interface Props {
  traces: AbdmAuditTraceDto[];
}

export const AbdmGatewayAuditVaultView: React.FC<Props> = ({ traces }) => {
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-bold text-gray-900">ABDM National Gateway Cryptographic Audit Vault</h2>
        <p className="text-xs text-gray-500">Immutable transaction log of all ABHA registrations, care-context links, consent approvals, and FHIR pushes</p>
      </div>
