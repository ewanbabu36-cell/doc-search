...
import type { TelehealthAuditTraceDto } from '@docsearch/api-contracts';

interface Props {
  traces: TelehealthAuditTraceDto[];
}

export const TelehealthAuditVaultView: React.FC<Props> = ({ traces }) => {
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-bold text-gray-900">Telehealth & Remote Patient Monitoring Cryptographic Audit Vault</h2>
        <p className="text-xs text-gray-500">Immutable append-only ledger of WebRTC video connections, device telemetry syncs, and emergency vital escalations</p>
      </div>
