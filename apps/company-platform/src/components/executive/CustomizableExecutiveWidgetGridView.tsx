...
const INITIAL_WIDGETS: DashboardWidget[] = [
  ...
  {
    id: 'WID-ER-02',
    title: '🚨 National Emergency ER Sirens',
    category: 'EMERGENCY',
    gridSpan: '1x1',
    value: '89 Dispatches',
  ...
  {
    id: 'WID-CONSULT-03',
    title: '🩺 Live Doctor Consultations / Hr',
    category: 'CLINICAL',
    gridSpan: '2x2',
    value: '15,160 / hr',
  ...
  {
    id: 'WID-QUOTA-04',
    title: '⚡ Tenant Quota Throttler Status',
  ...
  {
    id: 'WID-SEC-05',
    title: '🛡️ SOC2 Intrusion Threat Radar',
    category: 'SECURITY',
    gridSpan: '2x1',
    value: 'Zero Breaches',
  ...
  {
    id: 'WID-FX-06',
    title: '🌐 Multi-Currency Net Take-Rate',
    category: 'REVENUE',
    gridSpan: '1x1',
    value: '15.2% Margin',
